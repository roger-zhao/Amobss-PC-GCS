...
{
    public partial class Vibration_copy : Form
    {
        public Vibration_copy()
        {
            InitializeComponent();
        ...
        {
            VibBarX.Value = (int)(MainV2.comPort.MAV.cs.ekfposvert * 100);
            ...
            foreach (var item in new VerticalProgressBar2[] { VibBarX })
            {
                if (item.Value > 50)
