...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigFlightModes : UserControl, IActivate, IDeactivate
    {
        ...
        //Added by HL below
        private void FlightModes_Redesign()
        {
            this.tableLayoutPanel1.Controls.Remove(labelfm4);
            this.tableLayoutPanel1.Controls.Remove(labelfm5);
            this.tableLayoutPanel1.Controls.Remove(labelfm6);

            this.tableLayoutPanel1.Controls.Remove(CMB_fmode4);
            this.tableLayoutPanel1.Controls.Remove(CMB_fmode5);
            this.tableLayoutPanel1.Controls.Remove(CMB_fmode6);

            this.tableLayoutPanel1.Controls.Remove(CB_simple4);
            this.tableLayoutPanel1.Controls.Remove(CB_simple5);
            this.tableLayoutPanel1.Controls.Remove(CB_simple6);

            this.tableLayoutPanel1.Controls.Remove(chk_ss4);
            this.tableLayoutPanel1.Controls.Remove(chk_ss5);
            this.tableLayoutPanel1.Controls.Remove(chk_ss6);

            this.tableLayoutPanel1.Controls.Remove(label9);
            this.tableLayoutPanel1.Controls.Remove(label10);
            this.tableLayoutPanel1.Controls.Remove(label11);
        }
        //Added by HL above
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            if (MainV2.comPort.MAV.cs.firmware == MainV2.Firmwares.ArduCopter2) // ac2
            {
                ...
                LBL_flightmodepwm.Text = "6: " + MainV2.comPort.MAV.cs.ch5in;
