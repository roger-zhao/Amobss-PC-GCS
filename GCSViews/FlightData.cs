...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        //Added by HL below
        private System.Windows.Forms.Form form_hud1;
        private System.Windows.Forms.CheckBox checkBox_hud;
        private System.Windows.Forms.CheckBox checkBox_data;
        private System.Windows.Forms.CheckBox checkBox_actions;
        public System.Windows.Forms.Form form_downloadLog;
        private EKFStatus form_EKFStatus;
        private Vibration form_Vibration;
        private Vibration_copy form_Vibration_copy;
        private System.Windows.Forms.CheckBox checkBox_eightAxis;
        private System.Windows.Forms.Form form_eightAxis;
        //Added by HL above

        // AB ZhaoYJ@2017-06-12 for actions when emergency
        public System.Windows.Forms.Form form_actions;
        public Panel panel_actions;
        // MissionPlanner.Utilities.Password validate_code("1");
        private Controls.MyButton BUT_rtl_now;
        private Controls.MyButton BUT_land_now;
        private Controls.MyButton BUT_stop_motor_now;
        ...
        public FlightData()
        {
            ...
            Hud1AndLog_Init();
            Panel1_Init();
            TableLayoutPanelQuick_Modify();
            this.MainH.Panel1Collapsed = true;
            this.paneldata3.Controls.Add(this.tableLayoutPanelQuick);
            this.tableLayoutPanelQuick.Dock = DockStyle.Fill;
            this.paneldata4.Controls.Add(this.tableLayoutPanelQuick2);
            this.tableLayoutPanelQuick2.Dock = DockStyle.Fill;
            //Added by HL above
            ...
            tabControlactions.TabPages.Remove(tabPagePreFlight);
        ...
        public void Activate()
        {
            ...
            //Deleted by HL below
            //暂时屏蔽掉从配置文件config.xml初始化飞行状态及切换成中文
            //for (int f = 1; f < 10; f++)
            //{
            //    // load settings
...
// square
        ...
        {
            string vcode = "F";
            string correct_code = "1";
            if (InputBox.Show("输入检验码", "请输入检验码 (校验码为数字<1>)", ref vcode, true) ==
        System.Windows.Forms.DialogResult.OK)
            {

                if(!vcode.Equals(correct_code))
                {
                    CustomMessageBox.Show("校验失败，无法执行控制命令！", "校验失败");
                    return false;

                }
                else
                {
                    CustomMessageBox.Show("校验成功，开始执行控制命令！", "校验成功");
                    return true;
                }
        ...
        private void BUT_land_now_Click(object sender, EventArgs e)
        {
            if (!verify_code()) return;
    ...
    ((Button)sender).Enabled = true;
        ...
        private void BUT_stop_motor_now_Click(object sender, EventArgs e)
        {
            ...
            {
                ((Button)sender).Enabled = false;
                // send motor stop command: disarmed motor now
        ...
        private void hud1_DoubleClick(object sender, EventArgs e)
        {
            ...
            dropout.Size = new Size(this.hud1.Width, this.hud1.Height + 20);
            SubMainLeft.Panel1.Controls.Remove(this.hud1);
            dropout.Controls.Add(this.hud1);
        ...
        //Added by HL below
        private void Hud1AndLog_Init()
        {
            form_hud1 = new Form();
            form_hud1.Size = new Size(this.hud1.Width, this.hud1.Height + 20);
            SubMainLeft.Panel1.Controls.Remove(this.hud1);
            form_hud1.Controls.Add(this.hud1);
            form_hud1.Resize += dropout_Resize;
            form_hud1.ControlBox = false;
            form_hud1.Text = "HUD";
            form_hud1.StartPosition = FormStartPosition.Manual;
            form_hud1.Location = new Point(625, 268);


            form_eightAxis = new Form();
            PictureBox pictureBox_eightAxis = new PictureBox();
            // pictureBox_eightAxis.Image = Image.FromFile(@"./EightAxis.png");
            pictureBox_eightAxis.Dock = DockStyle.Fill;
            pictureBox_eightAxis.SizeMode = PictureBoxSizeMode.AutoSize;
            form_eightAxis.Controls.Add(pictureBox_eightAxis);
            form_eightAxis.ControlBox = false;
            form_eightAxis.Text = "动力信息";
            form_eightAxis.StartPosition = FormStartPosition.Manual;
            form_eightAxis.Location = new Point(425, 168);
            form_eightAxis.AutoSize = true;
            form_eightAxis.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            form_eightAxis.MaximizeBox = false;

            // AB ZhaoYJ@2017-06-12 for actions
            form_actions = new Form();
            form_actions.ControlBox = false;
            form_actions.Text = "控制命令";
            form_actions.StartPosition = FormStartPosition.Manual;
            form_actions.Location = new Point(425, 168);
            form_actions.AutoSize = true;
            form_actions.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            form_actions.MaximizeBox = false;
            Int16 height_tmp = 10;
            Int16 height_incr = 40;
            // BUT_resumemis.Location = new Point(20, height_tmp);
            // form_actions.Controls.Add(BUT_resumemis);
            // height_tmp += height_incr;
            BUT_quickrtl.Location = new Point(20, height_tmp);
            BUT_quickrtl.Size = BUT_land_now.Size;
            form_actions.Controls.Add(BUT_quickrtl);
            height_tmp += height_incr;
            BUT_land_now.Location = new Point(20, height_tmp);
            form_actions.Controls.Add(BUT_land_now);
            height_tmp += height_incr;
            BUT_stop_motor_now.Location = new Point(20, height_tmp);
            form_actions.Controls.Add(BUT_stop_motor_now);
        ...
        private void Panel1_Init()
        {
            System.Windows.Forms.Label label_data = new System.Windows.Forms.Label();
            label_data.Text = "实时数据";
            label_data.Font = new System.Drawing.Font("Microsoft Sans Serif", 12.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            label_data.Top = 50;
            label_data.Left = 140;
            label_data.AutoSize = true;
            SubMainLeft.Panel1.Controls.Add(label_data);

            Int16 top_pos = 240;
            checkBox_eightAxis = new System.Windows.Forms.CheckBox();
            checkBox_eightAxis.Text = "动力信息";
            checkBox_eightAxis.Top = top_pos;
            checkBox_eightAxis.Left = 40;
            checkBox_eightAxis.AutoSize = true;
            this.paneldata4.Controls.Add(checkBox_eightAxis);
            checkBox_eightAxis.CheckedChanged += new System.EventHandler(this.checkBox_eightAxis_CheckedChanged);

            top_pos += 30;
            checkBox_hud = new System.Windows.Forms.CheckBox();
            checkBox_hud.Text = "仪表盘";
            checkBox_hud.Top = top_pos;
            checkBox_hud.Left = 40;
            checkBox_hud.AutoSize = true;
            this.paneldata4.Controls.Add(checkBox_hud);
            checkBox_hud.CheckedChanged += new System.EventHandler(this.checkBox_hud_CheckedChanged);

            top_pos += 30;
            checkBox_data = new System.Windows.Forms.CheckBox();
            checkBox_data.Text = "数据记录";
            checkBox_data.Top = top_pos;
            checkBox_data.Left = 40;
            checkBox_data.AutoSize = true;
            this.paneldata4.Controls.Add(checkBox_data);
            checkBox_data.CheckedChanged += new System.EventHandler(this.checkBox_data_CheckedChanged);

            // AB ZhaoYJ@2017-06-12 for actions when emergency
            top_pos += 30;
            checkBox_actions = new System.Windows.Forms.CheckBox();
            checkBox_actions.Text = "控制命令";
            checkBox_actions.Top = top_pos;
            checkBox_actions.Left = 40;
            checkBox_actions.AutoSize = true;
            this.paneldata4.Controls.Add(checkBox_actions);
            checkBox_actions.CheckedChanged += new System.EventHandler(this.checkBox_actions_CheckedChanged);

            form_EKFStatus = new EKFStatus();
            System.Windows.Forms.TableLayoutPanel tableLayoutPanel_ekf = form_EKFStatus.GetTableLayoutPanel();
            tableLayoutPanel_ekf.Dock = DockStyle.Fill;
            tableLayoutPanel_ekf.Location = new Point(0, 0);
            //SubMainLeft.Panel1.Controls.Add(tableLayoutPanel_ekf);
            paneldata1.Controls.Add(tableLayoutPanel_ekf);

            form_Vibration = new Vibration();
            System.Windows.Forms.TableLayoutPanel tableLayoutPanel_vib = form_Vibration.GetTableLayoutPanel();
            tableLayoutPanel_vib.Dock = DockStyle.Fill;
            tableLayoutPanel_vib.Location = new Point(0, 0);
            //SubMainLeft.Panel1.Controls.Add(tableLayoutPanel_vib);
            paneldata2.Controls.Add(tableLayoutPanel_vib);

            form_Vibration_copy = new Vibration_copy();
            System.Windows.Forms.TableLayoutPanel tableLayoutPanel_vib_copy = form_Vibration_copy.GetTableLayoutPanel();
            tableLayoutPanel_vib_copy.Dock = DockStyle.Fill;
            tableLayoutPanel_vib_copy.Location = new Point(240, 80);
            //SubMainLeft.Panel1.Controls.Add(tableLayoutPanel_vib_copy);
            paneldata5.Controls.Add(tableLayoutPanel_vib_copy);

            Rectangle ScreenArea = System.Windows.Forms.Screen.GetWorkingArea(this);
            this.paneldata1.Location = new System.Drawing.Point(ScreenArea.Width - 125, 5);
            this.paneldata2.Location = new System.Drawing.Point(ScreenArea.Width - 125, 205);
            this.paneldata5.Location = new System.Drawing.Point(ScreenArea.Width - 125, 405);

            this.paneldata1.Hide();
            this.paneldata2.Hide();
            this.paneldata5.Hide();
        }

        private void TableLayoutPanelQuick_Modify()
        {
            this.quickView1.Size = new System.Drawing.Size(100, 27);
            this.quickView2.Size = new System.Drawing.Size(100, 27);
            this.quickView3.Size = new System.Drawing.Size(100, 27);
            this.quickView4.Size = new System.Drawing.Size(100, 27);
            this.quickView5.Size = new System.Drawing.Size(100, 27);
            this.quickView6.Size = new System.Drawing.Size(100, 27);
            this.quickView7.Size = new System.Drawing.Size(100, 27);
            this.quickView8.Size = new System.Drawing.Size(100, 27);
            this.quickView9.Size = new System.Drawing.Size(100, 27);
            this.quickView10.Size = new System.Drawing.Size(100, 27);
            this.quickView11.Size = new System.Drawing.Size(100, 27);
            this.quickView12.Size = new System.Drawing.Size(100, 27);
            this.quickView13.Size = new System.Drawing.Size(100, 27);
            this.quickView14.Size = new System.Drawing.Size(100, 27);
        }

        private void checkBox_eightAxis_CheckedChanged(object sender, EventArgs e)
        {
            if (true == checkBox_eightAxis.Checked)
            {
                form_eightAxis.Show();
            }
            else
        ...
        private void checkBox_actions_CheckedChanged(object sender, EventArgs e)
        {

            if (true == checkBox_actions.Checked)
            {
                form_actions.Show();
            }
            else
        ...
        private void checkBox_hud_CheckedChanged(object sender, EventArgs e)
        {
            if (true == checkBox_hud.Checked)
            {
                form_hud1.Show();
            }
            else
        ...
        private void BUT_resumemis_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (MainV2.comPort.BaseStream.IsOpen)
                {
                    ...
                    if (InputBox.Show("断点续航", "断点续航于航点 ", ref lastwp) == DialogResult.OK)
                    {
                        int timeout = 0;
