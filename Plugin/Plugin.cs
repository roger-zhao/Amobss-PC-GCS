...
namespace MissionPlanner.Plugin
{
    ...
    public class PluginHost
    {
        ...
        {
            MainV2.instance.FlightPlanner.clearDrawpolygonsoverlayByPolyId(MainV2.instance.FlightPlanner.drawnpolygon.Tag.ToString()); // AB ZhaoYJ for compatible with new FP
        ...
        {
            return MainV2.instance.FlightPlanner.work_mode;
        }
