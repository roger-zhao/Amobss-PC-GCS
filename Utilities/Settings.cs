...
namespace MissionPlanner.Utilities
{
    ...
    public class Settings
    {
        ...
        const string FileName = "farring_config_G3.xml";
        ...
        {
            var path = Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + Path.DirectorySeparatorChar + "Farring-GCS" +
        ...
        {
            var path = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + Path.DirectorySeparatorChar + "Farring-GCS" +
                          Path.DirectorySeparatorChar;
        ...
        public void Save()
        {
            ...
            using (XmlTextWriter xmlwriter = new XmlTextWriter(filename, Encoding.UTF8))
            {
                ...
                // also enable speech
                // xmlwriter.WriteElementString("speechenable", "" + config[key]);
