...
namespace MissionPlanner.Utilities
{
    ...
    public class ThemeManager
    {
        ...
        public static GMarkerGoogleType wpMarkerColor = GMarkerGoogleType.lightblue;
        public static Color wpRouteColor = Color.LightSkyBlue;
        public static Color polyMarkerColor;
        public static Color polyRouteColor;
        ...
        public static void ApplyThemeTo(Control control)
        {
            ...
            if (control is MissionPlanner.GCSViews.ConfigurationView.ConfigESCCalibration)
            {
                (control as MissionPlanner.GCSViews.ConfigurationView.ConfigESCCalibration).AddColor();
            }
        }
...
> <Grid>";
        ...
        private static void SetBurntKermitColors()
        {
            ...
            BGColor = Color.Silver;                     // This changes the colour of the main menu background
            ControlBGColor = Color.White;              // This changes the colour of the sub menu backgrounds
            TextColor = Color.Black;                                        // This changes the colour of text
            BGColorTextBox = Color.White;              // This changes the colour of the background of textboxes
            ButtonTextColor = Color.Black;                    // This changes the colour of button text
            ButBG = Color.WhiteSmoke;                           // This changes the colour of button backgrounds (Top)
            ButBGBot = Color.AliceBlue;                       // This changes the colour of button backgrounds (Bot)
            ProgressBarColorTop = Color.Black;             // These three variables change the colours of progress bars
            ProgressBarColorBot = Color.SlateGray;
            ProgressBarOutlineColor = Color.DeepSkyBlue;
            BannerColor1 = BGColor;                // These two variables change the colours of banners such as "planner" umder configuration
            BannerColor2 = BGColor;
            ColorNotEnabled = Color.DarkGray;               // This changes the background color of buttons when not enabled
            ColorMouseOver = Color.LightBlue;                 // This changes the background color of buttons when the mouse is hovering over a button
            ColorMouseDown = Color.AliceBlue;                 // This changes the background color of buttons when the mouse is clicked down on a button
            CurrentPPMBackground = Color.White;                             // This changes the background colour of the current PPM setting in the flight modes tab
            ZedGraphChartFill = Color.Black;           // These three variables change the fill colours of Zed Graphs
            ZedGraphPaneFill = Color.Silver;
            ZedGraphLegendFill = Color.White;
            RTBForeColor = Color.Black;                                // This changes the colour of text in rich text boxes
            BSVButtonAreaBGColor = Color.LightSteelBlue;                             // This changes the colour of a backstageview button area
            UnselectedTextColour = Color.Black;                        // This changes the colour of unselected text in a BSV button
            HorizontalPBValueColor = Color.DeepSkyBlue;          // This changes the colour of the horizontal progressbar
